...
public class CreateNewAccountPage  extends BasePage {
    ...
    private By genderErrorMessage = By.xpath("//*[@class=\"uiContextualLayer uiContextualLayerLeft\"]/descendant::div[2]");
    //Initialises variable and assigns ID of Create New Account button
    private By createAccountButton = By.id("u_0_14");
    //Initialises variable and assigns ID of data policy
    private By dataPolicy = By.linkText("Data Policy");
    ...
    public void clickOnCreateButton() {
        navigateToByClickOnLocator(createAccountButton);
    }

    //Gets text from the element
    public String getTextGenderErrorMessage(){
        return getText(genderErrorMessage);
    }
    ...
    public List<WebElement> getListOfRadioButtons() {
        listOfRadioButtons = getDriver().findElements(By.name("sex"));
    ...
    public void selectMonthDropDown(String month) {
        ...
        //Selects month from drop-down list by index
    public void selectMonthDropDown(int index)  {
        Select monthDropDown = new Select(getDriver().findElement(By.id("month")));
        selectDropdownListValue(monthDropDown,8);
    ...
    //Navigates date policy page
    public void navigateToDatePolicyPage(){
        navigateToByClickOnLocator(dataPolicy);
    }
    //Switch to window by index
    public void switchToWindow(int index){
        super.switchToWindow(index);
    }
    //Switch to root window (CreateNewAccountPage)
    public  void switchToCreateNewAccountPage(){
        super.switchToRootWindow();
    }
